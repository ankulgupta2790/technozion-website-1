...
function AboutCard({ content, image, imgToRight, title }) {
  return (
    <div className="about-container">
      <div className={`flex flex-col md:flex-row-reverse mx-4 md:mx-10 mt-10 flex-wrap justify-center items-center bg-gray-900`}>
        ...
        <div className="card text-black p-10 rounded-md flex flex-wrap z-10">
