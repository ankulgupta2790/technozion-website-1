  ...
  return (
    <div className="about-container">
      <div className={`flex flex-col md:flex-row-reverse mx-4 md:mx-10 mt-10 flex-wrap justify-center items-center`}>
        <h1 className="flex-[100%] text-center text-4xl font-bold uppercase bg-gradient-to-r from-[#020928] to-[#F7CA17] inline-block text-transparent bg-clip-text">
          {title}
        </h1>

        {/* For small screens, image appears first */}
        <div className="card text-black hover:text-white p-10 rounded-md flex flex-wrap">
          <div className="z-10 flex justify-center items-center duration-700 flex-col sm:flex-row">
